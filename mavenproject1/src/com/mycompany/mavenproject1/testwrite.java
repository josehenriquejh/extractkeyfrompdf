...
public class testwrite {
    ...
    public void consultachaves(String caminhopdf, String caminhotxt, String chave) throws IOException{
        ...
        try (PDDocument doc = PDDocument.load(myFile)) {
            ...
            //System.out.println("Chave: " +text.substring(ind, ind+64).replace(" ", ""));
                    ...
                    writer.write("Não foi encontrada Danfe com chave de acesso iniciada em ''" + chave +"''");
                    writer.write("\r\n");}
